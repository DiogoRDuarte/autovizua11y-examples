      ...
      >
        <svg width={chartDimensions.width} height={chartDimensions.height}>
          <Group
            ...
            top={
              centerY + chartDimensions.marginTop + chartDimensions.marginBottom
            }
          >
            <Pie
              data={shortData}
            ...
            >
              {(pie) => {
                return pie.arcs.map((arc, index) => {
                  ...
                  const arcFill = getColor(
                    arc.data["Population, density and surface area"]
                  ); // We will use our custom function above to get the color of the shape.
                  return (
                    <>
                      <g
                        key={`arc-${arc.data["Population, density and surface area"]}-${index}`}
                      >
